...
/**
 * An entity is a submodel element that is used to model entities. Constraint
 * AASd-056: The semanticId of a Entity submodel element shall only reference a
 * ConceptDescription with the category ENTITY. The ConceptDescription describes
...
public interface Entity extends SubmodelElement {
     ...
     *
     * The asset attribute must be set if entityType is set to
     * 'SelfManagedEntity'. It is empty otherwise.
     *
     * Constraint AASd-014: Either the attribute globalAssetId or
     * externalAssetId of an Entity must be set if Entity/entityType is set to
    ...
    /**
     * Reference to an identifier key value pair representing an external
     ...
     *
     * @return Returns the IdentifierKeyValuePair for the property
     * specificAssetId.
     */
    ...
    /**
     * Describes statements applicable to the entity by a set of submodel
