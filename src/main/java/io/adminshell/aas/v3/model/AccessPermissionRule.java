...
public interface AccessPermissionRule extends Referable, Qualifiable {
    ...
    /**
     * Set of object-permission pairs that define the permissions per object
     * within the access permission rule.
     *
     * More information under
     * https://admin-shell.io/aas/3/0/RC01/AccessPermissionRule/permissionsPerObject
     *
     * @return Returns the List of PermissionsPerObjects for the property
     ...
     * https://admin-shell.io/aas/3/0/RC01/AccessPermissionRule/permissionsPerObject
     *
     * @param permissionsPerObjects desired value for the property
     * permissionsPerObjects.
     */
    void setPermissionsPerObjects(List<PermissionsPerObject> permissionsPerObjects);

    /**
     * Target subject attributes that need to be fulfilled by the accessing
     * subject to get the permissions defined by this rule.
     *
     * More information under
     * https://admin-shell.io/aas/3/0/RC01/AccessPermissionRule/targetSubjectAttributes
     *
     * @return Returns the SubjectAttributes for the property
     ...
     * https://admin-shell.io/aas/3/0/RC01/AccessPermissionRule/targetSubjectAttributes
     *
     * @param targetSubjectAttributes desired value for the property
     * targetSubjectAttributes.
     */
