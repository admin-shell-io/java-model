...
/**
 * Default implementation of package io.adminshell.aas.v3.model.DataElement
 * 
...
public class DefaultDataElement implements DataElement {
    ...
    /**
     * This builder class can be used to construct a DefaultDataElement bean.
     */
    public static class Builder extends DataElementBuilder<DefaultDataElement, Builder> {
        ...
        @Override
        protected DefaultDataElement newBuildingInstance() {
            return new DefaultDataElement();
        }
    }
}
