 ...
 * object or entity. Constraint AASd-054: The semanticId of a ReferenceElement
 * shall only reference a ConceptDescription with the category REFERENCE.
 */
@KnownSubtypes({
...
public interface ReferenceElement extends DataElement {
    ...
    /**
     * Reference to any other referable element of the same of any other AAS or
     * a reference to an external object or entity.
     *
