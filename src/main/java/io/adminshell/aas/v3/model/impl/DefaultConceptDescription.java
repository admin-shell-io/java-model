 ...
 * io.adminshell.aas.v3.model.ConceptDescription
 *
 * The semantics of a property or other elements that may have a semantic
 * description is defined by a concept description. The description of the
 * concept should follow a standardized schema (realized as data specification
 * template). Constraint AASd-051: A ConceptDescription shall have one of the
 * following categories: VALUE, PROPERTY, REFERENCE, DOCUMENT, CAPABILITY,
 * RELATIONSHIP, COLLECTION, FUNCTION, EVENT, ENTITY, APPLICATION_CLASS,
 * QUALIFIER, VIEW. Default: PROPERTY.
 */
public class DefaultConceptDescription implements ConceptDescription {
    ...
    /**
     * This builder class can be used to construct a DefaultConceptDescription
     * bean.
     */
