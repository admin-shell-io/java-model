...
public class CertificateImpl implements Serializable, Certificate {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Certificate", ""));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("A technical certificate proofing the identity through cryptographic measures.", "en"));
