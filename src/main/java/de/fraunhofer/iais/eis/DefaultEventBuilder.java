...
public class DefaultEventBuilder extends AbstractBuilder<DefaultEvent> {

    public DefaultEventBuilder() {
        super();
    }

    public DefaultEventBuilder(Builder<? extends ModelClass> builder) {
        super(builder);
    }
     ...
     */
    public DefaultEventBuilder categories(List<String> categories) {
     ...
     */
    public DefaultEventBuilder descriptions(List<LangString> descriptions) {
     ...
     */
    public DefaultEventBuilder displayNames(List<LangString> displayNames) {
     ...
     */
    public DefaultEventBuilder idShorts(List<String> idShorts) {
     ...
     */
    public DefaultEventBuilder qualifiers(List<Constraint> qualifiers) {
     ...
     */
    public DefaultEventBuilder dataSpecifications(List<Reference> dataSpecifications) {
     ...
     */
    public DefaultEventBuilder kinds(List<ModelingKind> kinds) {
     ...
     */
    public DefaultEventBuilder semanticIds(List<Reference> semanticIds) {
     ...
     */
    final public DefaultEvent build() {
        DefaultEvent defaultEvent = Util.fillInstanceFromMap(new DefaultEvent(), this.map);
        return defaultEvent;
    }
}
