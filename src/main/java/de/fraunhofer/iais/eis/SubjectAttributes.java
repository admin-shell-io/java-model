...
public interface SubjectAttributes {
	...
	* @return Returns the List of DataElements for the property subjectAttributesSubjectAttributes.
	...
	*/
	...
	public List<DataElement> getSubjectAttributesSubjectAttributes();
