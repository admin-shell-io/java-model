...
public class DefaultEvent implements Serializable, Event {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Event", ""));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("An event.", "en"));
	...
	*/
	...
	protected DefaultEvent() {
		id = VocabUtil.getInstance().createRandomUrl("event");
	}
	...
	*/
	...
	/**
	* This function returns a hash code value for the Event for the benefit of e.g. hash tables.
