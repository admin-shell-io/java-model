...
public class BlobBuilder {
     ...
     */
    public BlobBuilder category(String category) {
     ...
     */
    public BlobBuilder descriptions(List<LangString> descriptions) {
     ...
     */
    public BlobBuilder displayNames(List<LangString> displayNames) {
