...
public class ReferenceElementImpl implements Serializable, IReferenceElement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Reference Element", ""));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("A reference element is a data element that defines a logical reference to another element within the same or another AAS or a reference to an external object or entity.", "en"));
	...
	*/
	...
	protected IReference _referenceElementValue;
	...
	*/
	...
	final public IReference getReferenceElementValue() {
	...
	/**
	* "Reference to any other referable element of the same of any other AAS or a reference to an external object or entity."@en
	* @param _referenceElementValue_ desired value for the property referenceElementValue.
	* More information under https://admin-shell.io/aas/3/0/RC01/ReferenceElement/value
	*/
	final public void setReferenceElementValue (IReference _referenceElementValue_) {
