...
public class DefaultRelationshipElement implements Serializable, RelationshipElement {
	...
	@JsonIgnore
	protected List<TypedLiteral> labels = Arrays.asList(new TypedLiteral("Relationship Element", ""));
	...
	*/
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this.relationshipElementFirst,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			return Objects.equals(this.relationshipElementFirst, other.relationshipElementFirst) &&
