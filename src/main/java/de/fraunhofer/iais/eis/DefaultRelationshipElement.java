...
public class DefaultRelationshipElement implements Serializable, RelationshipElement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Relationship Element", ""));
	...
	*/
	public int hashCode() {
		return Objects.hash(new Object[]{super.hashCode(), this.first, this.second});
	}
	...
	*/
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			return super.equals(other) && Objects.equals(this.first, other.first) && Objects.equals(this.second, other.second);
		}
	}
