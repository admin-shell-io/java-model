...
public class AccessPermissionRuleBuilder {
     ...
     */
    public AccessPermissionRuleBuilder descriptions(List<LangString> descriptions) {
     ...
     */
    public AccessPermissionRuleBuilder displayNames(List<LangString> displayNames) {
