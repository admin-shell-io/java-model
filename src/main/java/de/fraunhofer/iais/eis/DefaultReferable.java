...
public class DefaultReferable implements Serializable, Referable {
	...
	*/
	public int hashCode() {
		return Objects.hash(new Object[]{super.hashCode(), this.referableCategory, this.description, this.displayName, this.idShort, this.parent});
	}
	...
	*/
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			return super.equals(other) && Objects.equals(this.referableCategory, other.referableCategory) && Objects.equals(this.description, other.description) && Objects.equals(this.displayName, other.displayName) && Objects.equals(this.idShort, other.idShort) && Objects.equals(this.parent, other.parent);
		}
	}
