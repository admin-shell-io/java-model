...
@JsonTypeName("aas:Capability")
public class DefaultCapability implements Serializable, Capability {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Capability", ""));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("A capability is the implementation-independent description of the potential of an asset to achieve a certain effect in the physical or virtual world.", "en"));
	...
	*/
	...
	/**
	* This function returns a hash code value for the Capability for the benefit of e.g. hash tables.
	* @return a hash code value for the Capability
	*/
	public int hashCode() {
	...
	* @return true if this Capability is the same as the obj argument; false otherwise.
	*/
