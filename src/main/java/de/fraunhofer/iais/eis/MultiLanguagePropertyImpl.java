...
public class MultiLanguagePropertyImpl implements Serializable, IMultiLanguageProperty {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Multi Language Property", ""));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("A property is a data element that has a multi language value.", "en"));
	...
	*/
	...
	protected ArrayList<? extends TypedLiteral> _multiLanguagePropertyValue;
	...
	*/
	...
	protected ArrayList<? extends IReference> _multiLanguagePropertyValueId;
	...
	*/
	...
	final public List<? extends TypedLiteral> getMultiLanguagePropertyValue() {
	...
	*/
	...
	final public List<? extends IReference> getMultiLanguagePropertyValueId() {
