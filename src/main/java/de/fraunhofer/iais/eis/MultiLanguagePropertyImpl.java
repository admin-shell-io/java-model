...
public class MultiLanguagePropertyImpl implements Serializable, MultiLanguageProperty {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Multi Language Property", ""));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("A property is a data element that has a multi language value.", "en"));
	...
	*/
	@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/MultiLanguageProperty/value", "multiLanguagePropertyValue"})
	 java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _multiLanguagePropertyValue;
	...
	*/
	@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/MultiLanguageProperty/valueId", "multiLanguagePropertyValueId"})
	 java.util.ArrayList<? extends Reference> _multiLanguagePropertyValueId;
	...
	*/
	...
	final public void setMultiLanguagePropertyValue (java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _multiLanguagePropertyValue_) {
	...
	final public void setMultiLanguagePropertyValueId (java.util.ArrayList<? extends Reference> _multiLanguagePropertyValueId_) {
