...
public class AnnotatedRelationshipElementBuilder {
     ...
     */
    public AnnotatedRelationshipElementBuilder descriptions(List<LangString> descriptions) {
     ...
     */
    public AnnotatedRelationshipElementBuilder displayNames(List<LangString> displayNames) {
