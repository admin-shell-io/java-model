...
public class BasicEventImpl implements Serializable, BasicEvent {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Basic Event", ""));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("A basic event.", "en"));
	...
	*/
	@NotNull@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/BasicEvent/observed", "basicEventObserved"})
	 Reference _basicEventObserved;
	...
	*/
	...
	Reference getBasicEventObserved() {
		return _basicEventObserved;
	}

	final public void setBasicEventObserved (Reference _basicEventObserved_) {
