...
public class BasicEventImpl implements Serializable, IBasicEvent {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Basic Event", ""));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("A basic event.", "en"));
	...
	*/
	...
	protected IReference _basicEventObserved;
	...
	*/
	...
	final public IReference getBasicEventObserved() {
		return _basicEventObserved;
	}

	
	/**
	* "Reference to the data or other elements that are being observed."@en
	* @param _basicEventObserved_ desired value for the property basicEventObserved.
	* More information under https://admin-shell.io/aas/3/0/RC01/BasicEvent/observed
	*/
	final public void setBasicEventObserved (IReference _basicEventObserved_) {
		this._basicEventObserved = _basicEventObserved_;
	}
