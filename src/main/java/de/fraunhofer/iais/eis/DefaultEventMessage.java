...
public class DefaultEventMessage implements Serializable, EventMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Event Message", ""));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Defines the necessary information of an event instance sent out or received.", "en"));
	...
	*/
	...
	/**
	* This function returns a hash code value for the EventMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the EventMessage
	*/
	public int hashCode() {
	...
	* @return true if this EventMessage is the same as the obj argument; false otherwise.
	*/
