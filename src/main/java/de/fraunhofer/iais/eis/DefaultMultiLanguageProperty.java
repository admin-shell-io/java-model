...
public class DefaultMultiLanguageProperty implements Serializable, MultiLanguageProperty {
	...
	*/
	@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/MultiLanguageProperty/value", "multiLanguagePropertyValue"})
	protected List<TypedLiteral> multiLanguagePropertyValues;
	...
	*/
	@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/MultiLanguageProperty/valueId", "multiLanguagePropertyValueId"})
	protected List<Reference> multiLanguagePropertyValueIds;
	...
	*/
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this.multiLanguagePropertyValues,
			this.multiLanguagePropertyValueIds,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			return Objects.equals(this.multiLanguagePropertyValues, other.multiLanguagePropertyValues) &&
				Objects.equals(this.multiLanguagePropertyValueIds, other.multiLanguagePropertyValueIds) &&
	...
	final public List<TypedLiteral> getMultiLanguagePropertyValues() {
		return multiLanguagePropertyValues;
	}
	
	final public void setMultiLanguagePropertyValues (List<TypedLiteral> multiLanguagePropertyValues) {
		this.multiLanguagePropertyValues = multiLanguagePropertyValues;
	}

	@JsonProperty("https://admin-shell.io/aas/3/0/RC01/MultiLanguageProperty/valueId")
	final public List<Reference> getMultiLanguagePropertyValueIds() {
		return multiLanguagePropertyValueIds;
	}
	
	final public void setMultiLanguagePropertyValueIds (List<Reference> multiLanguagePropertyValueIds) {
		this.multiLanguagePropertyValueIds = multiLanguagePropertyValueIds;
	}
