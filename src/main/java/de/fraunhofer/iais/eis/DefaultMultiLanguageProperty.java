...
public class DefaultMultiLanguageProperty implements MultiLanguageProperty {
     ...
     * a MultiLanguageProperty references a ConceptDescription then the ConceptDescription/category
     * shall be one of following values: PROPERTY."@en "Constraint AASd-012: If both, the
    ...
    public Object deepCopy() {
        ...
        other.value = (LangString) Util.clone(this.value);
    ...
    @IRI("https://admin-shell.io/aas/3/0/RC01/MultiLanguageProperty/value")
    final public LangString getValue() {
        return value;
    }

    final public void setValue(LangString value) {
        this.value = value;
    }
