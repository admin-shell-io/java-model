...
public class DefaultSubmodelElementBuilder extends AbstractBuilder<DefaultSubmodelElement> {
     ...
     */
    public DefaultSubmodelElementBuilder categories(List<String> categories) {
     ...
     */
    public DefaultSubmodelElementBuilder descriptions(List<LangString> descriptions) {
     ...
     */
    public DefaultSubmodelElementBuilder displayNames(List<LangString> displayNames) {
     ...
     */
    public DefaultSubmodelElementBuilder idShorts(List<String> idShorts) {
     ...
     */
    public DefaultSubmodelElementBuilder qualifiers(List<Constraint> qualifiers) {
     ...
     */
    public DefaultSubmodelElementBuilder dataSpecifications(List<Reference> dataSpecifications) {
     ...
     */
    public DefaultSubmodelElementBuilder kinds(List<ModelingKind> kinds) {
     ...
     */
    public DefaultSubmodelElementBuilder semanticIds(List<Reference> semanticIds) {
