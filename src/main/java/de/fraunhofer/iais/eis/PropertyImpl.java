...
public class PropertyImpl implements Serializable, Property {
	...
	*/
	@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/Property/propertyCategory", "propertyPropertyCategory"})
	 java.util.ArrayList<? extends Category> _propertyPropertyCategory;
	...
	*/
	@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/Property/value", "propertyValue"})
	 de.fraunhofer.iais.eis.util.TypedLiteral _propertyValue;
	...
	*/
	...
	final public void setPropertyPropertyCategory (java.util.ArrayList<? extends Category> _propertyPropertyCategory_) {
	...
	final public void setPropertyValue (de.fraunhofer.iais.eis.util.TypedLiteral _propertyValue_) {
	...
	final public void setPropertyValueId (Reference _propertyValueId_) {
