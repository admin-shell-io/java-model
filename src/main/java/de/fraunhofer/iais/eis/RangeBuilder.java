...
public class RangeBuilder {
	...
	*/
	public RangeBuilder referableCategory(String referableCategory) {
	...
	*/
	public RangeBuilder descriptions(List<LangStringSet> descriptions) {
	...
	*/
	public RangeBuilder displayName(LangStringSet displayName) {
