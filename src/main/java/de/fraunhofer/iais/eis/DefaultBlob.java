...
public class DefaultBlob implements Serializable, Blob {
	...
	*/
	@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/Blob/mimeType", "mimeType"})
	...
	*/
	@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/Blob/value", "value"})
	...
	*/
	...
	/**
	* This function returns a hash code value for the Blob for the benefit of e.g. hash tables.
	* @return a hash code value for the Blob
	*/
	public int hashCode() {
	...
	* @return true if this Blob is the same as the obj argument; false otherwise.
	*/
