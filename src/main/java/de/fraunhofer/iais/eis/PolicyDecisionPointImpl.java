...
public class PolicyDecisionPointImpl implements Serializable, PolicyDecisionPoint {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Policy Decision Point", ""));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Defines a security policy decision point (PDP). ", "en"));
	...
	*/
	@NotNull@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/PolicyDecisionPoint/externalPolicyDecisionPoints", "policyDecisionPointExternalPolicyDecisionPoints"})
	 boolean _policyDecisionPointExternalPolicyDecisionPoints;
