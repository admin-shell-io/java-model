...
public class DefaultEventElement implements Serializable, EventElement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Event Element", ""));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Defines the necessary information for sending or receiving events.", "en"));
	...
	*/
	...
	/**
	* This function returns a hash code value for the EventElement for the benefit of e.g. hash tables.
	* @return a hash code value for the EventElement
	*/
	public int hashCode() {
	...
	* @return true if this EventElement is the same as the obj argument; false otherwise.
	*/
