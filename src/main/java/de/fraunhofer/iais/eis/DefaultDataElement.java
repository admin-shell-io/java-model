...
public class DefaultDataElement implements Serializable, DataElement {
	...
	@JsonIgnore
	protected List<TypedLiteral> labels = Arrays.asList(new TypedLiteral("Data Element", ""));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comments = Arrays.asList(new TypedLiteral("A data element is a submodel element that is not further composed out of other submodel elements. A data element is a submodel element that has a value. The type of value differs for different subtypes of data elements.", "en"));
	...
	*/
	...
	protected DefaultDataElement() {
		id = VocabUtil.getInstance().createRandomUrl("dataElement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DefaultDataElement other = (DefaultDataElement) obj;
