...
public class DefaultReferenceElement implements Serializable, ReferenceElement {
	...
	*/
	...
	protected Reference referenceElementValue;
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this.referenceElementValue,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			return Objects.equals(this.referenceElementValue, other.referenceElementValue) &&
	...
	final public Reference getReferenceElementValue() {
		return referenceElementValue;
	}
	
	final public void setReferenceElementValue (Reference referenceElementValue) {
		this.referenceElementValue = referenceElementValue;
	}
