...
public class DefaultReferenceElement implements Serializable, ReferenceElement {
	...
	*/
	@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/ReferenceElement/value", "value"})
	...
	*/
	...
	/**
	* This function returns a hash code value for the ReferenceElement for the benefit of e.g. hash tables.
	* @return a hash code value for the ReferenceElement
	*/
	public int hashCode() {
