...
public class RangeImpl implements Serializable, Range {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Range", ""));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("An element that is referable by its idShort. This id is not globally unique. This id is unique within the name space of the element.", "en"));
	...
	*/
	@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/Range/max", "rangeMax"})
	 java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _rangeMax;
	...
	*/
	@JsonAlias({"https://admin-shell.io/aas/3/0/RC01/Range/min", "rangeMin"})
	 java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _rangeMin;
	...
	*/
	...
	final public void setRangeMax (java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _rangeMax_) {
		this._rangeMax = _rangeMax_;
	}
	...
	final public void setRangeMin (java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _rangeMin_) {
		this._rangeMin = _rangeMin_;
	}
