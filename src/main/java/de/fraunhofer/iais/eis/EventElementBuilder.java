...
public class EventElementBuilder {
	...
	*/
	public EventElementBuilder referableCategory(String referableCategory) {
	...
	*/
	public EventElementBuilder descriptions(List<LangStringSet> descriptions) {
	...
	*/
	public EventElementBuilder displayName(LangStringSet displayName) {
