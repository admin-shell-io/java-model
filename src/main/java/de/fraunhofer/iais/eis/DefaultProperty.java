...
public class DefaultProperty implements Serializable, Property {
	...
	*/
	...
	protected TypedLiteral propertyValue;
	...
	*/
	...
	protected Reference propertyValueId;
	...
	*/
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this.propertyValue,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			return Objects.equals(this.propertyValue, other.propertyValue) &&
				Objects.equals(this.propertyValueId, other.propertyValueId) &&
	...
	final public void setPropertyValue (TypedLiteral propertyValue) {
		this.propertyValue = propertyValue;
	}

	@JsonProperty("https://admin-shell.io/aas/3/0/RC01/Property/valueId")
	final public Reference getPropertyValueId() {
		return propertyValueId;
	}
	
	final public void setPropertyValueId (Reference propertyValueId) {
