...
public class SubmodelElementImpl implements Serializable, SubmodelElement {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Submodel Element", ""));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("A submodel element is an element suitable for the description and differentiation of assets.", "en"));
