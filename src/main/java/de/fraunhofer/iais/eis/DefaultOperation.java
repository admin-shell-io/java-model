...
public class DefaultOperation implements Serializable, Operation {
	...
	*/
	...
	protected List<OperationVariable> inoutputVariable;
	...
	*/
	...
	protected List<OperationVariable> inputVariable;
	...
	*/
	...
	protected List<OperationVariable> outputVariable;
	...
	* @return a hash code value for the Operation
	*/
	public int hashCode() {
		return Objects.hash(new Object[]{super.hashCode(), this.inputVariable, this.inoutputVariable, this.outputVariable});
	}

	/**
	* This function indicates whether some other object is equal to this one.
	* @param obj the reference object with which to compare.
	* @return true if this Operation is the same as the obj argument; false otherwise.
	*/
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			return super.equals(other) && Objects.equals(this.inputVariable, other.inputVariable) && Objects.equals(this.inoutputVariable, other.inoutputVariable) && Objects.equals(this.outputVariable, other.outputVariable);
		}
	}
	...
	*/
	...
	final public List<OperationVariable> getInputVariable() {
	...
	/**
	* "Input parameter of the operation."@en
	* @param inputVariable desired value for the property inputVariable.
	* More information under https://admin-shell.io/aas/3/0/RC01/Operation/inputVariable
	*/
	final public void setInputVariable (List<OperationVariable> inputVariable) {
	...
	*/
	...
	final public List<OperationVariable> getInoutputVariable() {
	...
	/**
	* "Parameter that is input and output of the operation."@en
	* @param inoutputVariable desired value for the property inoutputVariable.
	* More information under https://admin-shell.io/aas/3/0/RC01/Operation/inoutputVariable
	*/
	final public void setInoutputVariable (List<OperationVariable> inoutputVariable) {
	...
	*/
	...
	final public List<OperationVariable> getOutputVariable() {
	...
	/**
	* "Output parameter of the operation."@en
	* @param outputVariable desired value for the property outputVariable.
	* More information under https://admin-shell.io/aas/3/0/RC01/Operation/outputVariable
	*/
	final public void setOutputVariable (List<OperationVariable> outputVariable) {
