...
public interface Referable {
    ...
    List<LangStringSet> getDescriptions();
     ...
     */
    void setDescriptions(List<LangStringSet> descriptions);
    ...
    List<LangStringSet> getDisplayNames();
     ...
     */
    void setDisplayNames(List<LangStringSet> displayNames);
